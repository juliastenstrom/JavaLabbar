...
public class Lab5 {
	...
	public static void main(String[] args) {
		...
		//System.out.println(theEstateAgent.sort(EstateAgent.ALLBUILDNINGS));
		//System.out.println(theEstateAgent);
		...
		//System.out.println(theEstateAgent.sort(EstateAgent.CITYBUILDNINGS));
		//System.out.println(theEstateAgent);
		*/
		
		Villa v = new Villa ("poo", 1.0, 1, 1.0, 1.0, 1);
